...
$link=mysql_connect("localhost","root","")or die("can not connect");
	mysql_select_db("sourcecodester_jobportal",$link) or die("can not select database");
	
	$q = "select * from employers where er_companyemail = '".$_POST['email']."'";
	...
	header("location:process_employer_login.php");
		}
	}
	else
	{
...
<table width="264" border="0" cellspacing="0" cellpadding="0">
 ...
 <span style="color:red";>Wrong username or password,Try again! </span> 
