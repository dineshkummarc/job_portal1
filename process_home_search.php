...
DEFINE('DATABASE_NAME', 'sourcecodester_jobportal');
...
$query = "select j_id,j_title,j_city,j_experience,j_category,j_company,j_vacancy from jobs where (j_title='$keyword' or j_city='$keyword' )or(j_company='$keyword')";
